...
public class Main {
    public static void main(String[] args) {
        ...
        BuyCoffeeButton buyCoffeeButton = new BuyCoffeeButton(state, mediator);
        BuyTeaButton buyTeaButton = new BuyTeaButton(state, mediator);
        ReturnCoinButton returnCoinButton = new ReturnCoinButton(state, mediator);
